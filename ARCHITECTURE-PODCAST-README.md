...
- **fq → openmetadata**: Metadata ingestion from data assets
- **openmetadata → aix**: Policy input through Moat connectors
- **aix → fq**: Authorization decisions for Trino queries
